...
class ERM2(Algorithm):
    """
    Empirical Risk Minimization (ERM)
    """

    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(ERM2, self).__init__(input_shape,
                                   num_classes, num_domains, hparams)
        self.encoder, self.scale, self.pcl_weights = networks.encoder(hparams)
        self._initialize_weights(self.encoder)
        self.fea_proj, self.fc_proj = networks.fea_proj(hparams)
...
class Mixstyle(Algorithm):
    ...
    def __init__(self, input_shape, num_classes, num_domains, hparams):
        assert input_shape[1:3] == (
            224, 224), "Mixstyle support R18 and R50 only"
...
class ARM(ERM):
    ...
    def __init__(self, input_shape, num_classes, num_domains, hparams):
        ...
        super(ARM, self).__init__(input_shape,
                                  num_classes, num_domains, hparams)
...
class IRM(ERM):
    ...
    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(IRM, self).__init__(input_shape,
                                  num_classes, num_domains, hparams)
        self.register_buffer("update_count", torch.tensor([0]))
...
class VREx(ERM):
    ...
    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(VREx, self).__init__(input_shape,
                                   num_classes, num_domains, hparams)
        self.register_buffer("update_count", torch.tensor([0]))
...
class Mixup(ERM):
    ...
    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(Mixup, self).__init__(input_shape,
                                    num_classes, num_domains, hparams)
...
class MLDG(ERM):
    ...
    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(MLDG, self).__init__(input_shape,
                                   num_classes, num_domains, hparams)
...
class MTL(Algorithm):
    ...
    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(MTL, self).__init__(input_shape,
                                  num_classes, num_domains, hparams)
        self.featurizer = networks.Featurizer(input_shape, self.hparams)
        ...
        self.register_buffer("embeddings", torch.zeros(
            num_domains, self.featurizer.n_outputs))
...
class SagNet(Algorithm):
    ...
    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(SagNet, self).__init__(input_shape,
                                     num_classes, num_domains, hparams)
        # featurizer network
...
class RSC(ERM):
    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(RSC, self).__init__(input_shape,
                                  num_classes, num_domains, hparams)
